                        ...
                        <div className='chatbot-messagebox'>
                            ...
                            <div className='chatbot-inputs'>
                                <div className='chatbot-inputbar'>
                                    <input type="text" value={prompt} onChange={(e) => setPrompt(e.target.value)} className='chatbot-inputtext' placeholder='Ask Uday...'/>
                                </div>
