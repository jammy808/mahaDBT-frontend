...
function Form() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      formik.setValues({
        _id: user._id || formik.values._id,
        username: user.username || formik.values.username,
        firstName: user.personalDetails?.firstName || formik.values.firstName,
        middleName: user.personalDetails?.middleName || formik.values.middleName,
        lastName: user.personalDetails?.lastName || formik.values.lastName,
        mobileNo: user.personalDetails?.mobileNo || formik.values.mobileNo,
        guardianMobileNo: user.personalDetails?.guardianMobileNo || formik.values.guardianMobileNo,
        birthDate: user.personalDetails?.birthDate || formik.values.birthDate,
        address: user.personalDetails?.address || formik.values.address,
        gender: user.personalDetails?.gender || formik.values.gender,
        age: user.personalDetails?.age || formik.values.age,
        isIncomeCertificateAvailable: user.incomeDetails?.isIncomeCertificateAvailable || formik.values.isIncomeCertificateAvailable,
        annualIncome: user.incomeDetails?.annualIncome || formik.values.annualIncome,
        issuedDate: user.incomeDetails?.issuedDate || formik.values.issuedDate,
        totalMarks: user.educationDetails?.totalMarks || formik.values.totalMarks,
        percentage: user.educationDetails?.percentage || formik.values.percentage,
        college: user.educationDetails?.college || formik.values.college,
        course: user.educationDetails?.course || formik.values.course,
        bankAccountNo: user.bankAccountNo || formik.values.bankAccountNo,
        incomeCertificate: user.incomeDetails?.incomeCertificate || formik.values.incomeCertificate,
        marksheet: user.educationDetails?.marksheet || formik.values.marksheet,
        userImage: user.personalDetails?.userImage || formik.values.userImage,
        incomeCertificateNo: user.incomeDetails?.incomeCertificateNo || formik.values.incomeCertificateNo,
      });
